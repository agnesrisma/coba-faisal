...
var lyr_ADMINISTRASIKEC_1 = new ol.layer.Vector({
                ...
                interactive: true,
                title: '<img src="styles/legend/ADMINISTRASIKEC_1.png" /> ADMINISTRASIKEC'
            });
...
lyr_GoogleSatellite_0.setVisible(true);lyr_ADMINISTRASIKEC_1.setVisible(true);lyr_RSKOTAMADIUNPT_2.setVisible(true);lyr_TEMPATIBADAHMADIUN_3.setVisible(true);lyr_PENDIDIKAN_4.setVisible(true);
var layersList = [lyr_GoogleSatellite_0,lyr_ADMINISTRASIKEC_1,lyr_RSKOTAMADIUNPT_2,lyr_TEMPATIBADAHMADIUN_3,lyr_PENDIDIKAN_4];
...
lyr_ADMINISTRASIKEC_1.set('fieldLabels', {'KDPPUM': 'no label', 'NAMOBJ': 'no label', 'REMARK': 'no label', 'KDPBPS': 'no label', 'FCODE': 'no label', 'LUASWH': 'no label', 'UUPP': 'no label', 'SRS_ID': 'no label', 'LCODE': 'no label', 'METADATA': 'no label', 'KDEBPS': 'no label', 'KDEPUM': 'no label', 'KDCBPS': 'no label', 'KDCPUM': 'no label', 'KDBBPS': 'no label', 'KDBPUM': 'no label', 'WADMKD': 'no label', 'WIADKD': 'no label', 'WADMKC': 'no label', 'WIADKC': 'no label', 'WADMKK': 'no label', 'WIADKK': 'no label', 'WADMPR': 'no label', 'WIADPR': 'no label', 'TIPADM': 'no label', 'SHAPE_Leng': 'no label', 'SHAPE_Area': 'no label', });
...
lyr_TEMPATIBADAHMADIUN_3.set('fieldLabels', {'NAMA OBJEK': 'no label', 'KOORDINAT': 'no label', 'KOORDINA_1': 'no label', 'ALAMAT': 'no label', 'TELP': 'header label - always visible', 'BUKA': 'no label', });
